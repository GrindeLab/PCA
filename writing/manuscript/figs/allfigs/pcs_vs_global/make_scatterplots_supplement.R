...
#### UPDATE THIS ####
#/projects/thornton/Lisa_Admixture_Mapping/results/covariates/pcs_4/pca_snprelate_exclude_lit_prune_0.1_0.5.txt
whi.pcs <- read_table('../WHI/pca_snprelate_exclude_lit_prune_0.1_0.5.txt', col_names = F)
names(whi.pcs) <- c('ID1', 'ID2', 'PC1', 'PC2', 'PC3', 'PC4')
...
#### UPDATE THIS ####
#/projects/browning/brwnlab/kelsey/spurious_assoc/jhs/pcs/snprelate_excludeTRUE_rsq0.1_win5e%2B05_maf0.01.RData
jhs.pcs <- get_obj('../JHS/snprelate_excludeTRUE_rsq0.1_win5e+05_maf0.01.RData')
...
#### UPDATE THIS ####
#/projects/browning/brwnlab/kelsey/spurious_assoc/copd/pcs/snprelate_excludeTRUE_rsq0.1_win0.5_maf0.01.RData
copd.pcs <- get_obj('../COPD/snprelate_excludeTRUE_rsq0.1_win0.5_maf0.01.RData')
...
ggsave(plot = pcombined, 'pruned_pcs_vs_global.pdf', width = 7, height = 7, units = 'in', dpi = 'print')
